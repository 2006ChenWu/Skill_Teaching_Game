class WordClassificationGame {
    ...
    async loadGameData() {
        try {
            ...
            this.showMessage('Failed to load game data. Please check if server is running on port 3000.', 'error');
        }
    }
    ...
    loadWordsForLevel() {
        ...
        // Updated message to reflect difficulty-based level description
    ...
    createSingleFirework() {
        ...
        const colors = ['#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff', '#00ffff', '#ff6b6b', '#4ecdc4', '#45b7d1', '#96ceb4'];
